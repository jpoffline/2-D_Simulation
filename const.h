...
#define TIME_N 200000     // This is the total time steps in the simulation
...
#define GENERATE_OUTPUT 10000  //after how many iterations one want to generate an output
